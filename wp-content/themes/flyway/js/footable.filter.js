// modified to allow filtering by category for Flyway website
...
(function ($, w, undefined) {
  ...
  function Filter() {
    ...
    p.showRow = function(row, ft) {
      ...
      // if the current row's category is not among the active categories, make sure it is hidden, then return
      if ($table.attr('data-' + $row.attr('data-category')) == 'true') {
	      $row.show();
      }
    };
  };
